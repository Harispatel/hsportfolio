...
function About({props}) {
  ...
  return (
    <div className="page-section" style={{background:props.isDM?COLORS.SECONDARY:COLORS.WHITE}}>
...
<Row>
  <Col xs={12} xl={6} lg={6}>
      ...
      :<Card
    hoverable
    style={{backgroundColor: props.isDM?COLORS.GREY: COLORS.TRANSPARENT}}
    // cover={<img alt="example" src="https://play-lh.googleusercontent.com/sOmuVIBIoGhLcHzlErTbZsdhEbtaAMsbcLAMbGorLXdhuERu4eeyVk3bPxMjVuX6kfs" />}
    cover={<img alt="example" src={IMAGES.HSP_PROFILE} />}
  >
    <Row>
      
        <img alt="example" src={IMAGES.REACT_LOGO} className="skills-logo"/>
      
      
        <img alt="example" src={IMAGES.PHP_LOGO} className="skills-logo"/>

        <img alt="example" src={IMAGES.NODE_LOGO} className="skills-logo"/>
...
trends and continuously enhancing skills.</p>
    </Card>
  </Col>
  </Row>
      </div>
